...
export default function TableGrid({ disable, getInput ,gridName}) {
    ...
    const { 
        areaData, initialStateLoader, createDataLoader } = useSelector(
    ...
    return (
        ...
        >
          ...
          <Select  name="List Of Area" data={areaData.DATA}/>
